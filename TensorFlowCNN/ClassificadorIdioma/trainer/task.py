...
tf.flags.DEFINE_string("spanish_data_file", spanish_data_file, "Data source for the spanish data.")
tf.flags.DEFINE_string("portuguese_data_file", portuguese_data_file, "Data source for the portuguese data.")
...
# Load data
print("Loading data...")
x_text, y = util.load_data_and_labels(FLAGS.spanish_data_file, FLAGS.portuguese_data_file)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.join(output_dir, "runs", timestamp)
        print("Writing to {}\n".format(out_dir))
